    ...
    <main className="app-shell">
      <aside className="sidebar">
        ...
        <div className="sidebar-footer">
          ...
          <a className="mobile-apps-card" href="/download/TRDriver.apk?v=0.6.0" download="TRDriver.apk" type="application/vnd.android.package-archive">
            <span className="android-mark" aria-hidden>▶</span>
            <div>
              <strong>Android APK</strong>
              <small>İndir ve yükle · v0.6.0</small>
            </div>
          </a>
          <button
            type="button"
